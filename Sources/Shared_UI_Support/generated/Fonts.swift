...
public enum FontFamily {
  public enum Pixelmix {
    public static let regular = FontConvertible(name: "pixelmix", family: "pixelmix", path: "pixelmix.ttf")
    public static let all: [FontConvertible] = [regular]
  }
  public static let allCustomFonts: [FontConvertible] = [Pixelmix.all].flatMap { $0 }
