...
public struct Movie: Codable, Identifiable {
    ...
    static func placeholder(id: Int) -> Movie {
        ...
        return Movie(id: id, originalTitle: "", title: "", overview: "", posterPath: nil, backdropPath: nil, popularity: 0.0, voteAverage: 0.0, voteCount: 0, releaseDate: nil, genres: nil, runtime: nil, status: nil, video: false)
